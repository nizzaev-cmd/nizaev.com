(function(){
  ...
  const dict = {
    en: {
      ...
      'svc.4.t':'Full product launch — concept to live sales','svc.4.d':"End-to-end launch support: I take a product and turn it into a working e-commerce system — audience, assortment, branding, online store, payments, ads, Amazon setup and first sales.",'svc.4.unit':'end-to-end',
      'svc.4.l1':'Target-audience definition','svc.4.l2':'Assortment matrix','svc.4.l3':'Branding & visual identity','svc.4.l4':'Online shop setup (Shopify or equivalent)','svc.4.l5':'Payments integration','svc.4.l6':'Instagram & paid social launch','svc.4.l7':'Amazon onboarding & first shipment','svc.4.l8':'First-sales milestone',
      ...
      'form.opt1':'30-minute consultation — €50','form.opt2':'Growth audit — €800','form.opt3':'Scaling to US — €1,600','form.opt4':'Full product launch — €2,800','form.opt5':'Fractional Head of E-commerce','form.opt6':'Something else',
    ...
    es: {
      ...
      'svc.4.t':'Lanzamiento completo — del concepto a las ventas','svc.4.d':'De principio a fin: tomo el producto de un creador y lo llevo al e-commerce. Público, surtido, branding, tienda online, pagos, anuncios, Amazon — hasta que entran los primeros pedidos.','svc.4.unit':'integral',
      'svc.4.l1':'Definición del público objetivo','svc.4.l2':'Matriz de surtido','svc.4.l3':'Branding e identidad visual','svc.4.l4':'Tienda online (Shopify o equivalente)','svc.4.l5':'Integración de pagos','svc.4.l6':'Lanzamiento Instagram y paid social','svc.4.l7':'Alta en Amazon y primer envío','svc.4.l8':'Primeras ventas',
      ...
      'form.opt1':'Consulta 30 min — 50 €','form.opt2':'Auditoría de crecimiento — 800 €','form.opt3':'Escalado a EE. UU. — 1.600 €','form.opt4':'Lanzamiento completo — 2.800 €','form.opt5':'Fractional Head of E-commerce','form.opt6':'Otra cosa',
    ...
    ru: {
      ...
      'exp.kicker':'Экспертиза','exp.title':'Пять вещей, в которых я <em>сильнее большинства.</em>',
      ...
      'svc.4.t':'Полный запуск продукта — от идеи до продаж','svc.4.d':'Под ключ: беру продукт поставщика и вывожу его в e-commerce. Аудитория, ассортимент, брендинг, интернет-магазин, платежи, реклама, маркетплейс — до первых заказов.','svc.4.unit':'под ключ',
      'svc.4.l1':'Определение целевой аудитории','svc.4.l2':'Ассортиментная матрица','svc.4.l3':'Брендинг и визуальная идентика','svc.4.l4':'Интернет-магазин (Shopify или аналог)','svc.4.l5':'Подключение платежей','svc.4.l6':'Запуск рекламы в Instagram и paid social','svc.4.l7':'Онбординг в Amazon и первая поставка','svc.4.l8':'Первые продажи',
      ...
      'form.opt1':'Консультация 30 минут — 50 €','form.opt2':'Аудит бизнеса — 800 €','form.opt3':'Выход на рынок США — 1 600 €','form.opt4':'Полный запуск продукта — 2 800 €','form.opt5':'Fractional Head of E-commerce','form.opt6':'Другое',
