(function(){
  ...
  const dict = {
    en: {
      ...
      'form.opt1':'30-minute consultation — €70','form.opt2':'Growth audit — €800','form.opt3':'Scaling to US — €1,600','form.opt4':'Full product launch — €2,990','form.opt5':'Fractional Head of E-commerce','form.opt6':'Something else',
    ...
    es: {
      ...
      'form.opt1':'Consulta 30 min — 70 €','form.opt2':'Auditoría de crecimiento — 800 €','form.opt3':'Escalado a EE. UU. — 1.600 €','form.opt4':'Lanzamiento completo — 2.990 €','form.opt5':'Fractional Head of E-commerce','form.opt6':'Otra cosa',
    ...
    ru: {
      ...
      'form.opt1':'Консультация 30 минут — 70 €','form.opt2':'Аудит бизнеса — 800 €','form.opt3':'Выход на рынок США — 1 600 €','form.opt4':'Полный запуск продукта — 2 990 €','form.opt5':'Fractional Head of E-commerce','form.opt6':'Другое',
