(function(){
  ...
  const dict = {
    en: {
      ...
      'svc.1.t':'30-minute consultation','svc.1.d':'A short call to unblock one specific question — marketplace, channel, pricing, sourcing, launch. Bring the question; you leave with a direction.','svc.1.unit':'flat · 30 min','svc.1.price':'$150',
      ...
      'form.opt1':'30-minute consultation — $150','form.opt2':'Growth audit — €800','form.opt3':'Scaling to US — €1,600','form.opt4':'Full product launch — €2,990','form.opt5':'Fractional Head of E-commerce','form.opt6':'Something else',
    ...
    es: {
      ...
      'svc.1.t':'Consulta de 30 minutos','svc.1.d':'Una llamada corta para desbloquear una pregunta concreta — marketplace, canal, pricing, sourcing, lanzamiento. Tú traes la pregunta; te llevas una dirección.','svc.1.unit':'tarifa fija · 30 min','svc.1.price':'130 €',
      ...
      'form.opt1':'Consulta 30 min — 130 €','form.opt2':'Auditoría de crecimiento — 800 €','form.opt3':'Escalado a EE. UU. — 1.600 €','form.opt4':'Lanzamiento completo — 2.990 €','form.opt5':'Fractional Head of E-commerce','form.opt6':'Otra cosa',
    ...
    ru: {
      ...
      'svc.1.t':'Консультация 30 минут','svc.1.d':'Короткая консультация по конкретному вопросу — продукт, канал, цены, поставки, запуск. Вы приходите с вопросом — уходите с направлением.','svc.1.unit':'фикс · 30 мин','svc.1.price':'130 €',
      ...
      'form.opt1':'Консультация 30 минут — 130 €','form.opt2':'Аудит бизнеса — 800 €','form.opt3':'Выход на рынок США — 1 600 €','form.opt4':'Полный запуск продукта — 2 990 €','form.opt5':'Fractional Head of E-commerce','form.opt6':'Другое',
